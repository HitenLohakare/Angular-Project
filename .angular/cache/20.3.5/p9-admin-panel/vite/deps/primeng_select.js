...
import {
  ...
  ɵɵtwoWayProperty,
  ɵɵviewQuery
} from "./chunk-MKERM7IO.js";
import {
  Subject
} from "./chunk-PT6HF6UR.js";
import {
  __spreadProps,
  __spreadValues
...
function Y(e, t = "", r = "", s4 = [], i2) {
  if (p(e)) {
    ...
    if (ht2(a2)) return;
    if (z2(a2, k3)) {
      let n = a2.replaceAll(k3, (l) => {
        let c2 = l.replace(/{|}/g, "").split(".").filter((m2) => !s4.some((d) => z2(m2, d)));
...
function le(e, t) {
  ...
  function r(n, l) {
    ...
    for (; c2 <= n.length; ) {
      let g = n[c2];
      if ((g === '"' || g === "'" || g === "`") && n[c2 - 1] !== "\\" && (d = d === g ? null : g), !d && (g === "(" && u++, g === ")" && u--, (g === "," || c2 === n.length) && u === 0)) {
        let f2 = m2.trim();
        f2.startsWith("dt(") ? o.push(le(f2, l)) : o.push(s4(f2)), m2 = "", c2++;
        continue;
      }
      g !== void 0 && (m2 += g), c2++;
    }
  ...
  for (let n = i2.length - 1; n >= 0; n--) {
    let [l, o] = i2[n], c2 = e.slice(l + 3, o), m2 = r(c2, t), d = t(...m2);
...
var ue = (e = {}, t, r, s4) => {
  if (t) {
    let { variable: i2, options: a2 } = S.defaults || {}, { prefix: n, transform: l } = (e == null ? void 0 : e.options) || a2 || {}, o = z2(t, k3) ? t : `{${t}}`;
...
function de(e, t = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g = m2[u], f2 = ve(g), p2 = z2(u, a2) ? Q(d) : Q(d, ee(u));
      if (i(f2)) o.push({ node: f2, path: p2 });
      else {
        let y2 = ae(p2), R2 = Y(f2, p2, s4, [a2]);
        Re(l, y2, R2);
        let T = p2;
  ...
  let c2 = l.join("");
  return { value: l, tokens: n, declarations: c2, css: C2(i2, c2) };
}
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var R2, T, j3, O2, M2, z3, V;
  let { preset: a2, options: n } = t, l, o, c2, m2, d, u, g;
  if (s2(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re } = a2, f2 = te || {}, { colorScheme: K2 } = f2, A2 = v2(f2, ["colorScheme"]), x2 = re || {}, { colorScheme: X } = x2, G2 = v2(x2, ["colorScheme"]), p2 = K2 || {}, { dark: U2 } = p2, B = v2(p2, ["dark"]), y2 = X || {}, { dark: I } = y2, H = v2(y2, ["dark"]), W2 = s2(L) ? this._toVariables({ primitive: L }, n) : {}, q2 = s2(A2) ? this._toVariables({ semantic: A2 }, n) : {}, Z = s2(B) ? this._toVariables({ light: B }, n) : {}, pe = s2(U2) ? this._toVariables({ dark: U2 }, n) : {}, fe = s2(G2) ? this._toVariables({ semantic: G2 }, n) : {}, ye = s2(H) ? this._toVariables({ light: H }, n) : {}, Se = s2(I) ? this._toVariables({ dark: I }, n) : {}, [Me, ze] = [(R2 = W2.declarations) != null ? R2 : "", W2.tokens], [Ke, Xe] = [(T = q2.declarations) != null ? T : "", q2.tokens || []], [Ge, Ue] = [(j3 = Z.declarations) != null ? j3 : "", Z.tokens || []], [Be, Ie] = [(O2 = pe.declarations) != null ? O2 : "", pe.tokens || []], [He, We] = [(M2 = fe.declarations) != null ? M2 : "", fe.tokens || []], [qe, Ze] = [(z3 = ye.declarations) != null ? z3 : "", ye.tokens || []], [Fe, Je] = [(V = Se.declarations) != null ? V : "", Se.tokens || []];
    ...
    d = `${et2}${tt}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g = m(a2.css, { dt: E });
  }
  return { primitive: { css: l, tokens: o }, semantic: { css: c2, tokens: m2 }, global: { css: d, tokens: u }, style: g };
}, getPreset({ name: e = "", preset: t = {}, options: r, params: s4, set: i2, defaults: a2, selector: n }) {
  var f2, x2, p2;
  let l, o, c2;
  if (s2(t) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t, { colorScheme: R2, extend: T, css: j3 } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d = T || {}, { colorScheme: M2 } = d, z3 = v2(d, ["colorScheme"]), u = R2 || {}, { dark: V } = u, L = v2(u, ["dark"]), g = M2 || {}, { dark: te } = g, re = v2(g, ["dark"]), K2 = s2(O2) ? this._toVariables({ [y2]: h2(h2({}, O2), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y2]: h2(h2({}, L), re) }, r) : {}, X = s2(V) ? this._toVariables({ [y2]: h2(h2({}, V), te) }, r) : {}, [G2, U2] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B, I] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H, W2] = [(p2 = X.declarations) != null ? p2 : "", X.tokens || []], q2 = this.transformCSS(y2, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H, "dark", "variable", r, i2, a2, n);
    l = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U2, ...I, ...W2])], c2 = m(j3, { dt: E });
  }
  return { css: l, tokens: o, style: c2 };
  ...
  var c2, m2;
  let a2 = e.replace("-directive", ""), { preset: n, options: l } = t, o = ((c2 = n == null ? void 0 : n.components) == null ? void 0 : c2[a2]) || ((m2 = n == null ? void 0 : n.directives) == null ? void 0 : m2[a2]);
  ...
  let n = this.getCommon({ name: e, theme: t, params: r, set: i2, defaults: a2 }), l = Object.entries(s4).reduce((o, [c2, m2]) => o.push(`${c2}="${m2}"`) && o, []).join(" ");
  ...
  var c2;
  let n = { name: e, theme: t, params: r, set: i2, defaults: a2 }, l = (c2 = e.includes("-directive") ? this.getPresetD(n) : this.getPresetC(n)) == null ? void 0 : c2.css, o = Object.entries(s4).reduce((m2, [d, u]) => m2.push(`${d}="${u}"`) && m2, []).join(" ");
  return l ? `<style type="text/css" data-primevue-style-id="${e}-variables" ${o}>${G(l)}</style>` : "";
}, createTokens(e = {}, t, r = "", s4 = "", i2 = {}) {
  let a2 = function(l, o = {}, c2 = []) {
    if (c2.includes(this.path)) return console.warn(`Circular reference detected at ${this.path}`), { colorScheme: l, path: this.path, paths: o, value: void 0 };
    c2.push(this.path), o.name = this.path, o.binding || (o.binding = {});
    let m2 = this.value;
    if (typeof this.value == "string" && k3.test(this.value)) {
      let u = this.value.trim().replace(k3, (g) => {
        var y2;
        let f2 = g.slice(1, -1), x2 = this.tokens[f2];
        if (!x2) return console.warn(`Token not found for path: ${f2}`), "__UNRESOLVED__";
        let p2 = x2.computed(l, o, c2);
    ...
    return a(o.binding) && delete o.binding, c2.pop(), { colorScheme: l, path: this.path, paths: o, value: m2.includes("__UNRESOLVED__") ? void 0 : m2 };
  }, n = (l, o, c2) => {
    Object.entries(l).forEach(([m2, d]) => {
      let u = z2(m2, t.variable.excludedKeyRegex) ? o : o ? `${o}.${oe(m2)}` : oe(m2), g = c2 ? `${c2}.${m2}` : m2;
      i(d) ? n(d, u, g) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x2 = {}, p2 = []) => {
  ...
  if (s2(t)) {
    ...
    if (s4 !== "style") {
      ...
      t = r === "dark" ? c2.reduce((m2, { type: d, selector: u }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t) : this.getSelectorRule(u, l, d, t)), m2), "") : C2(l != null ? l : ":root,:host", t);
    }
    if (o) {
...
var BaseStyle = class _BaseStyle {
  ...
  load = (style8, options = {}, transform = (cs) => cs) => {
    const computedStyle = transform(ar`${m(style8, {
      dt: E
    })}`);
  ...
  loadTheme = (options = {}, style8 = "") => {
    return this.load(this.theme, options, (computedStyle = "") => S.transformCSS(options.name || this.name, `${computedStyle}${ar`${style8}`}`));
  };
...
var DomHandler = class _DomHandler {
  ...
  static getViewport() {
    let win = window, d = document, e = d.documentElement, g = d.getElementsByTagName("body")[0], w2 = win.innerWidth || e.clientWidth || g.clientWidth, h3 = win.innerHeight || e.clientHeight || g.clientHeight;
...
var Scroller = class _Scroller extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    contentQueries: function Scroller_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        ɵɵcontentQuery(dirIndex, _c059, 4);
...
function Select_ng_template_9_p_scroller_6_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵstyleMap(ɵɵpureFunction1(8, _c060, ctx_r2.scrollHeight));
...
function Select_ng_template_9_ng_template_8_ng_template_2_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngStyle", ɵɵpureFunction1(7, _c060, scrollerOptions_r20.itemSize + "px"));
...
function Select_ng_template_9_ng_template_8_li_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngStyle", ɵɵpureFunction1(4, _c060, scrollerOptions_r20.itemSize + "px"));
    ɵɵadvance();
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function SelectItem_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵproperty("id", ctx.id)("ngStyle", ɵɵpureFunction1(15, _c060, ctx.itemSize + "px"));
